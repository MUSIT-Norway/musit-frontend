...
import observationReducer, {
  loadObservation,
  initialState
} from 'reducer/observation'
import mapToFrontEnd from 'reducer/observation/mapper/to_frontend'
import mapToBackEnd from 'reducer/observation/mapper/to_backend'
