...
export default () => (
  <div>
    ...
    <p>
      Samarbeidstiltaket gjelder Arkeologisk museum, Kulturhistorisk museum, Naturhistorisk museum, NTNU Vitenskapsmuseet, Tromsø museum – Universitetsmuseet, og Universitetsmuseet i Bergen.
    </p>
    <p>
      Universitetsmuseene forvalter de største samlingene i Norge innenfor en rekke fagfelt som arkeologi, botanikk, etnografi, geologi, numismatikk og zoologi. MUSIT er den sentrale forvalter av universitetsmuseenes samlingsdata, og skal tilby løsninger som gjør datasett lett tilgjengelig for bruk i forskning, forvaltning og formidling.
    </p>
    <br />
    <br />
  </div>
