...
describe('ObservationDoubleTextAreaComponent', () => {
  it('renders two textareas', () => {
    ...
    expect(wrapper.find('MusitTextArea[placeHolder="Left placeholder"]').length).toEqual(
      1
    );
    expect(wrapper.find('MusitTextArea[placeHolder="Right placeholder"]').length).toEqual(
      1
    );
