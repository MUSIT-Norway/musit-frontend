...
type Props = {
  ...
  addOrUpdateAnalysisEvent: Function
};
...
export const saveAnalysisEventLocal = (appSession: AppSession, form: FormData, store: Store, addOrUpdateAnalysisEvent: Function) =>
  () => addOrUpdateAnalysisEvent({
...
const AnalysisComponent = ({ form, updateForm, store, addOrUpdateAnalysisEvent, appSession } : Props) => (
  <div>
    <br/>
    ...
    <NewLine />
    <SaveCancel
      onClickSave={saveAnalysisEventLocal(appSession, form, store, addOrUpdateAnalysisEvent)}
    />
    <NewLine />
    <Form horizontal>
      <FormGroup>
...
AnalysisComponent.propTypes = {
  ...
  addOrUpdateAnalysisEvent: PropTypes.func,
