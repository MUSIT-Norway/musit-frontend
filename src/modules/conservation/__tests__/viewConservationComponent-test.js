...
const props: any = {
  ...
  store: {
    ...
    conservation: {
      ...
      updatedDate: '2017-11-21T14:50:01+00:00',
      affectedThings: [
        {
          objectData: {
            id: 28,
      ...
      events: [
        {
          ...
          affectedThings: [
            ...
            'ba56a4f6-b907-4158-9a67-bca6080320bb',
  ...
  match: {
    path: '/museum/:museumId/collections/:collectionIds/conservation/:conservationId',
    url: '/museum/99/collections/00000000-0000-0000-0000-000000000000/conservation/112',
    isExact: true,
    params: {
      museumId: '99',
  ...
  location: {
    pathname:
      '/museum/99/collections/00000000-0000-0000-0000-000000000000/conservation/112',
    search: '',
    hash: '',
    key: 'rr5vfp'
  },
