...
class MusitNode {
  ...
  static getNode: (ajaxGet: AjaxGet) => (
    props: {
      id: string,
      museumId: number,
      token: string,
  ...
  static getNodeWithUpdatedBy: (ajaxGet: AjaxGet) => (
    props: {
      id: string,
      museumId: number,
      token: string,
  ...
  static addNode: (ajaxPost: AjaxPost) => (
    props: {
      id: string,
      museumId: number,
      token: string,
  ...
  static editNode: (ajaxPut: AjaxPut) => (
    props: {
      id: string,
      museumId: number,
      token: string,
  ...
  static getNodes: (ajaxGet: AjaxGet) => (
    props: {
      id: string,
      page?: Paging,
      museumId: number,
  ...
  static getStats: (ajaxGet: AjaxGet) => (
    props: {
      id: string,
      museumId: number,
      token: string,
  ...
  static deleteNode: (ajaxDel: AjaxDel) => (
    props: {
      id: string,
      museumId: number,
      token: string,
  ...
  static moveNode: (ajaxPut: AjaxPut) => (
    props: {
      id: string,
      destination: string,
      doneBy: string,
  ...
  static pickNode: (pickNode$: Subject) => (
    props: {
      node: mixed,
  ...
  static findNodeOrObjectByBarcode: (ajaxGet: AjaxGet) => (
    props: {
      barcode: number,
      museumId: number,
      collectionId: string,
  ...
  static findByUUID: (ajaxGet: AjaxGet) => (
    props: {
      uuid: string,
      museumId: number,
      token: string
