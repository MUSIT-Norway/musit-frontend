export type SavedFile = {
  ...
  export function isErrorLoading(fileOrError: SavedFile | ErrorLoading): fileOrError is ErrorLoading {
    return (fileOrError as ErrorLoading).error !== undefined;
  }
  
  export function isErrorSaving(fileOrError: SavedFile | ErrorSaving): fileOrError is ErrorSaving {
