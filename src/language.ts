    ...
    "musit": {
      "conservation": {
        ...
        "errorMessages": {
          ...
          "notAllowed":
            "You do not have the appropriate access rights to see conservation."
        },
        "note": "Note",
        ...
        "events": {
          "treatment": {
            ...
            "materialUsageDetails":
              "Material Usage (Product Name, Synonyms, Description)",
          ...
          "measurementDetermination": {
            "tooltip": {
              ...
              "quantityTooltip":
                "Original number of objects(whole and/or broken",
      ...
      "objects": {
        ...
        "objectsView": {
          ...
          "termItem": "Artefact",
          "term": "Artefact/Taxon",
          "messageToSelectObjects":
            "Which objects are connected to the sub-event?",
      ...
      "errorMainMessages": {
        ...
        "scanner": {
          ...
          "noMatchingNode":
            "Could not find any matching node with this barcode.",
          "noMatchingObject":
            "Could not find any matching object with this barcode.",
          "cannotActOnObject":
            "This window can not act on barcodes for objects.",
          "cannotActOnNode":
        ...
        "objects": {
          "notAllowedToSeeAnalysis":
            "No access to analysis or samples for object",
          "notAllowedToSeeConservations":
            "No access to conservations for object",
          "notAllowedToSeeStorageData":
            "No access to storage data for this object"
        }
      },
      ...
      "leftMenu": {
        "node": {
          ...
          "deleteMessages": {
            ...
            "errorNotAllowedHadChild":
              "Not allowed to delete a node that is not empty."
          },
      ...
      "texts": {
        "search": "Search",
        "pageSizeMessage" : "To improve the performance, location of objects/samples will not show on the search result.",
        "numberRangeMessage" : "Museum number range must be in 12..13 format.",
        "clearSearch": "Clear search",
        "cookiesBlockedMessage": "Cookies blocked. You must enable cookies in Your browser to use this service.",
        ...
        "doNotHaveSufficientRole":
          "Do not have sufficient role to perform the operation",
        "error": "Error message",
      ...
      "newControl": {
        ...
        "controlsRequired":
          "At least one control type must be checked OK or Not OK",
      ...
      "observation": {
        "page": {
          ...
          "dateValidation":
            "Date of observation can not be later than present date.",
          "typeSelect": {
          ...
          "pest": {
            ...
            "identificationValueIncorrect":
              "Max length for identification is 100 char.",
            "commentsValueIncorrect":
              "Max length for Task/Comment is 250 char.",
            "countIncorrect": "Quantity must be an integer.",
            "lifeCycleRequired":
              "Stage is required when quantity is specified.",
            "labelText": "Pest",
          ...
          "alcohol": {
            ...
            "volumeValueIncorrect":
              "Volume must be a number with max 3 decimals.",
          ...
          "temperature": {
            ...
            "toValueIncorrect":
              "Measured value (to) must be a number with max 3 decimals.",
            "commentsValueIncorrect":
              "Max length for Task/Comment is 250 char.",
          ...
          "cleaning": {
            "leftValueRequired":
              "Description of observed cleaning is required.",
            "leftValueIncorrect": "Max length for Description is 100 char.",
            "rightValueIncorrect": "Max length for Task/Comment is 250 char.",
            "labelText": "Cleaning",
            "leftLabelText": "Description",
          ...
          "lightCondition": {
            ...
            "leftValueIncorrect":
              "Max length for measured/observed value is 100 char.",
            "rightValueIncorrect": "Max length for Task/Comment is 250 char.",
          ...
          "tyverisikring": {
            "leftValueRequired":
              "Description of theft protection status is required.",
            "leftValueIncorrect": "Max length for description is 100 char.",
            "rightValueIncorrect": "Max length for Task/Comment is 250 char.",
      ...
      "storageUnits": {
        ...
        "environmentRequirement": {
          ...
          "relativeHumidity": {
            ...
            "incorrect":
              "Relative humidity must be a number with max 3 decimals.",
    ...
    "musit": {
      "conservation": {
        ...
        "events": {
          "treatment": {
            ...
            "synonyms": "Synonymer",
            "materialUsageDetails":
              "Materialbruk (Produktnavn, Synonymer, Beskrivelse)",
          ...
          "measurementDetermination": {
            "tooltip": {
              ...
              "quantityTooltip":
                "Opprinnelig antall objekter(hele og/eller ødelagte",
              "quantitySymbolTooltip":
                "Angi evt. usikkerhet i antall med >(minst) eller ?",
              "fragmentQuantityTooltip":
      ...
      "objects": {
        ...
        "objectsView": {
          ...
          "messageToSelectObjects":
            "Hvilke objekter gjelder denne del hendelsen for?",
      ...
      "analysis": {
        ...
        "exchange": {
          ...
          "description":
            "Last opp den utfylte malen og verifiser at de feltene stemmer.",
      ...
      "moveModal": {
        ...
        "messages": {
          ...
          "errorObjects":
            "Flytting av %{count} objekter til %{destination} feilet."
        }
      },
      "leftMenu": {
        "node": {
          ...
          "deleteMessages": {
            ...
            "errorNotAllowedHadChild":
              "Noden er ikke tom, og kan derfor ikke slettes."
          },
      ...
      "texts": {
        "search": "Søk",
        "pageSizeMessage" : "For å forbedre ytelsen vil plasseringen av objekter / prøver ikke vises på søkeresultatet.",
        "numberRangeMessage" : "Museumsnummer-intervall må være på formen 12..13",
        "clearSearch": "Blank søk",
        "cookiesBlockedMessage": "Cookies blokkert. Du må endre innstillingene i nettleseren din til å godta cookies for å bruke denne tjenesten.",
      ...
      "newControl": {
        ...
        "dateValidation":
          "Dato for kontrollen kan ikke være større enn dagens dato.",
      ...
      "observation": {
        "page": {
          ...
          "dateValidation":
            "Dato for observasjonen kan ikke være større enn dagens dato.",
          "typeSelect": {
            "labelText": "Velg type"
          },
          "messages": {
          ...
          "pest": {
            ...
            "identificationValueIncorrect":
              "Identifikasjon kan ha maks 100 tegn.",
          ...
          "alcohol": {
            ...
            "volumeValueIncorrect":
              "Volum må være et tall med maks 3 desimaler.",
          ...
          "mold": {
            ...
            "leftValueIncorrect":
              "Beskrivelse av observert mugg kan ha maks 100 tegn.",
          ...
          "cleaning": {
            ...
            "leftValueIncorrect":
              "Beskrivelse av observert renhold kan ha maks 100 tegn.",
            "rightValueIncorrect": "Tiltak/kommentar kan ha maks 250 tegn.",
            "labelText": "Renhold",
            "leftLabelText": "Beskrivelse",
            "rightLabelText": "Tiltak/Kommentar",
          ...
          "skallsikring": {
            "leftValueRequired":
              "Beskrivelse av skallsikringens tilstand er påkrevd.",
            "leftValueIncorrect":
          ...
          "brannsikring": {
            "leftValueRequired":
              "Beskrivelse av brannsikringens tilstand er påkrevd.",
            "leftValueIncorrect":
          ...
          "vannskaderisiko": {
            ...
            "leftValueIncorrect":
              "Beskrivelse av vannskaderisiko kan ha maks 100 tegn.",
            "rightValueIncorrect": "Tiltak/kommentar kan ha maks 250 tegn.",
          ...
          "tyverisikring": {
            "leftValueRequired":
              "Beskrivelse av tyverisikringens tilstand er påkrevd.",
            "leftValueIncorrect":
      ...
      "storageUnits": {
        ...
        "environmentRequirement": {
          ...
          "relativeHumidity": {
            ...
            "incorrect":
              "Relativ luftfuktighet må være et tall med maks 3 desimaler.",
