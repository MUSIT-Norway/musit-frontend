...
export default combineReducers({
  storageGridUnit: nodeReducer,
  storageObjectGrid: objectReducer,
  storageUnitStats: statsReducer
});
...
export const nodesSelector = createSelector(
  [state => getGridData(state.storageGridUnit)],
...
export const totalNodesSelector = (state) => state.storageGridUnit.data && state.storageGridUnit.data.totalMatches;

export const objectsSelector = createSelector(
  [state => getGridData(state.storageObjectGrid)],
...
export const totalObjectsSelector = (state) => state.storageObjectGrid.data && state.storageObjectGrid.data.totalMatches;

export const rootNodeSelector = (state) => state.storageGridUnit.root.data;

export const statsSelector = (state) => state.storageUnitStats;
